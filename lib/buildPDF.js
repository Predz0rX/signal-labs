...
// Extract first dollar amount or short value from a long string
...
async function buildPDF({ reportData, industry, company, country, userContext }) {
  ...
  // Gauge: semicircle arc length ≈ 94.25 (π*30), scale to score/100
  ...
  const replacements = {
    ...
    // SVG trend line Y positions (inverted: 0=top=100, 78=bottom=0)
